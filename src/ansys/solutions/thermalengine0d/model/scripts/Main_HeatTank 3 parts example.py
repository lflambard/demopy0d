...
Tank2to3Convection = HET_R()
HeatTank3 = VolumeFluid_C_2HEX()
...
HeatTank1.Param(Volume_Tank / 3, Cp_water, Rho_water, BulkModulus_water, P0, T0)
Tank1to2Convection.Param(h_tank, Surface_Tank)
HeatTank2.Param(Volume_Tank / 3, Cp_water, Rho_water, BulkModulus_water, P0, T0)
Tank2to3Convection.Param(h_tank, Surface_Tank)
HeatTank3.Param(Volume_Tank / 3, Cp_water, Rho_water, BulkModulus_water, P0, T0)
TankConvection.Param(h_air, Surface_Tank)
Heating.Param(0)
Target.Param(T_control)
PI_Heat.Param(10, 0.5, 0, 10)
...
result_simu[0, 2] = HeatTank3.Eth1.T
result_simu[0, 3] = HeatTank3.E1.P
result_simu[0, 4] = 0
result_simu[0, 5] = HeatTank1.Eth1.T
result_simu[0, 6] = HeatTank2.Eth1.T
...
for i in range(1, int(LastVal+1)):
    ...
    HeatTank2.F2 = HeatTank3.F1
    HeatTank2.Fth1 = Tank1to2Convection.Fth2
    HeatTank2.Fth2 = Tank2to3Convection.Fth1
    HeatTank2.Solve(step_simu, method)

    "Thermal Exchanges Tank 2 to 3 (convection)"
    Tank2to3Convection.Eth1 = HeatTank2.Eth2
    Tank2to3Convection.Eth2 = HeatTank3.Eth1
    Tank2to3Convection.Solve(step_simu, method)

    "Heat Tank3"
    HeatTank3.F1 = HeatTank2.F2
    HeatTank3.F2 = Tank_output.F
    HeatTank3.Fth1 = Tank2to3Convection.Fth2
    HeatTank3.Fth2 = TankConvection.Fth2
    ...
    if incr_save > incr_save_old:
        ...
        result_simu[incr_save, 2] = HeatTank3.Eth1.T
        result_simu[incr_save, 3] = HeatTank3.E1.P
        result_simu[incr_save, 4] = PI_Heat.y
        result_simu[incr_save, 5] = HeatTank1.Eth1.T
        result_simu[incr_save, 6] = HeatTank2.Eth1.T
